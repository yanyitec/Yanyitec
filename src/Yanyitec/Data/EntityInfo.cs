...
namespace Yanyitec.Data
{
    public class EntityInfo
    {
        ...
        public FieldInfo PrimaryFieldInfo { get; internal protected set; }
        ...
        public FieldInfo GetField(string propname) {
            FieldInfo result = null;
            this._fields.TryGetValue(propname, out result);
            return result;
        }

        public FieldInfo TryGetField(params string[] propnames)
        {
            foreach (var field in this._fields.Values) {
                if (propnames.Contains(field.PropertyInfo.Name)) return field;
            }
            return null;
        }
