(function (Global, document) {
    ...
    var Promise = (function (yi, async) {
        ...
        Then.Whenable.prototype = new Thenable();
        ...
        Then.Whenable.call(Promise.prototype);
        Promise.Whenable = Then.Whenable;
